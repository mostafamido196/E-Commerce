...
import com.samy.groceryapp.databinding.ActivityPlacedOrderBinding;
...
public class PlacedOrderActivity extends AppCompatActivity {
    private ActivityPlacedOrderBinding binding;
    ...
    private void sendData(List<MyCartModel> list) {
                ...
                firestore.collection("CurrentUser").document(auth.getCurrentUser().getUid())
                        .collection("MyOrder").add(cartMap).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                            ...
                            public void onComplete(@NonNull Task<DocumentReference> task) {
                                Toast.makeText(PlacedOrderActivity.this, "Your Order Has Been Pleased", Toast.LENGTH_SHORT).show();
                            }
                        });
            }
        }
